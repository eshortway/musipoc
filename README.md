...
Invoke-WebRequest -Uri http://www.dl.musisystems.com/musi-agent-1.4.82-1.msi -OutFile $env:tmp\musi-agent; msiexec.exe /i $env:tmp\musi-agent /q MUSI_MANAGER='192.168.88.55' MUSI_AGENT_GROUP='MOEnergy'
...
Invoke-WebRequest -Uri http://www.dl.musisystems.com/musi-agent-1.4.82-1.msi -OutFile $env:tmp\musi-agent; msiexec.exe /i $env:tmp\musi-agent /q MUSI_MANAGER='siem2c.musisystems.com' MUSI_AGENT_GROUP='MOEnergy'
